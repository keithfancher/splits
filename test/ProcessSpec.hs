...
spec = do
  describe "process" $ do
    it "processes and summarizes two sets of debts correctly!" $ do
...
expectedSummaries =
  [ MonthlyDebtSummary (YearAndMonth 2022 08) P1OwesP2 (-243) 21.5, -- TODO: bug! negatives breaking who owes whom
